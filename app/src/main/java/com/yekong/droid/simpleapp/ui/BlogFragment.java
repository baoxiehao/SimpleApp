...
public class BlogFragment extends RecyclerPageFragment<
        LinkItem, LinkContract.View, LinkContract.BlogPresenter>
        implements LinkContract.View {

    @Override
    public LinkContract.BlogPresenter createPresenter() {
        return new LinkContract.BlogPresenter();
    }
